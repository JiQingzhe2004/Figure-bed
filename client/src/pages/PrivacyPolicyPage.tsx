...
const PrivacyPolicyPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        ...
        // 获取隐私政策内容，简单处理Markdown格式
        let markdownContent = response.settings.privacy_policy || '隐私政策内容尚未设置';
        // 替换标题格式
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6 text-gray-800 dark:text-white">隐私政策</h1>
